...
RPROMPT='${time}%{$fg_bold[magenta]%}$(git_prompt_info)%{$reset_color%}$(git_prompt_status)%{$reset_color%}'

# Add this at the start of RPROMPT to include rvm info showing ruby-version@gemset-name
# %{$fg[yellow]%}$(~/.rvm/bin/rvm-prompt)%{$reset_color%} 

# local time, color coded by last return code
time_enabled="%(?.%{$fg_bold[green]%}.%{$fg[red]%})%*%{$reset_color%}"
...
ZSH_THEME_GIT_PROMPT_UNMERGED="%{$fg[magenta]%} asd" # ⓤ ⑊
